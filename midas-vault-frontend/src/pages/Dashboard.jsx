            ...
            <div key={transaction.id} className="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-midas-gold hover:shadow-xl transition-all duration-300">
              ...
              <div className="flex space-x-3">
                ...
                {transaction.status === 'completed' && (
                  <span className="text-transparent bg-gradient-to-r from-green-500 to-emerald-500 bg-clip-text font-semibold flex items-center space-x-2">
                    <svg 
                ...
                {transaction.status === 'refunded' && (
                  <span className="text-transparent bg-gradient-to-r from-red-500 to-pink-500 bg-clip-text font-semibold flex items-center space-x-2">
                    <svg 
